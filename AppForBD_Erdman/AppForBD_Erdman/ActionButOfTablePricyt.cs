    ...
    public partial class Form1 : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                SqlCommand command = new SqlCommand($"INSERT INTO [Pocechenie_Pricyt] (dateOfLecii, nameOfLecii, TimeOfLecii, Pricytcvoval_Name) VALUES (@dateOfLecii, @nameOfLecii, @TimeOfLecii, @Pricytcvoval_Name)", connection);
                ...
                SqlDataAdapter dataAdapter = new SqlDataAdapter(
                    "SELECT * FROM Pocechenie_Pricyt ORDER BY ID DESC", connectionString);
