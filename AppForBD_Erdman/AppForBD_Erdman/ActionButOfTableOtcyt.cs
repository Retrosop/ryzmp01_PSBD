    ...
    public partial class Form1 : Form
    {
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                SqlCommand command = new SqlCommand($"INSERT INTO [Pocechenie_Otcytctvoval] (dateOfLecii, nameOfLecii, TimeOfLecii, Oncytctvoval_Name) VALUES (@dateOfLecii, @nameOfLecii, @TimeOfLecii, @Oncytctvoval_Name)", connection);
                ...
                SqlDataAdapter dataAdapter = new SqlDataAdapter(
                    "SELECT * FROM Pocechenie_Otcytctvoval ORDER BY ID DESC", connectionString);
